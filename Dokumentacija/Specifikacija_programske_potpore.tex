\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\begin{packed_enum}
					\item \textbf{*sva funkcionalnost Klijenta bez brisanje svog računa*}
				...
				\begin{packed_enum}
					\item \textbf{*sva funkcionalnost Vlasnika bez funckionalost klijenta*}
			...
			\subsection{Obrasci uporabe}				
				\subsubsection{Opis obrazaca uporabe}					
					...
					\noindent \underbar{\textbf{UC14 - Uklanjanje recepta}}
					\begin{packed_item}
