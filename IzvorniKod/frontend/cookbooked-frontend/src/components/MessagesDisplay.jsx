                        ...
                        {msgs.map((el=>(
                            ...
                            <div className="flex items-center space-x-4 rtl:space-x-reverse">
                                ...
                                <div className="flex justify-center w-2/6">
                                    <>
                                    <button  type="button" data-modal-toggle="message"  onClick={e => e.preventDefault()} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Odgovori</button>
                                    <MessageSendPopUp id={`${el.id}`} reciverId={el.senderId}/>
                                    </>
                                </div>
                            </div>
