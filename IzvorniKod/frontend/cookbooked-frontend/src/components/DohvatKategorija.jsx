...
function DohvatKategorija({cat, children}) {
    ...
    return (
        <li>
            ...
            <div id="dropdownNavbar" className={`z-10 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600 ${isOpen ? "block" : "hidden"}`}> 
